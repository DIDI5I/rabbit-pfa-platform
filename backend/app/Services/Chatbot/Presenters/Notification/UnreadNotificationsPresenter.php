...
class UnreadNotificationsPresenter extends BaseResponsePresenter
{
    protected const PREVIEW_LIMIT = 3;

    public function supports(string $tool): bool
    {
        return $tool === 'unread_notifications';
    }
    ...
    public function present(array $toolResult, array $identity): array
    {
        ...
        if ($unreadCount === 0) {
            ...
            $answer = "You have {$unreadCount} unread notification" . ($unreadCount === 1 ? '' : 's') . ". Showing {$shown}.";
        }
